...
→ Try it now: [https://fidozbox-dev.github.io/XCTrackLayoutEditor/XCtrackLayoutEditor.html](https://fidozbox-dev.github.io/XCTrackLayoutEditor/XCtrackLayoutEditor.html)


No installation, no account, 100% free and works offline if you save the page on you computer. 
...
How to use
1.	Export your config from XCTrack (Settings → Backup)
2.	Open the HTML file in your browser
3.	Load your .xcfg file (drag & drop)
